...
partial class CalculatorForm
{
    ...
    private FlowLayoutPanel pnlPowerMode;
    ...
    private void InitializeComponent()
    {
        ...
        pnlPowerMode = new FlowLayoutPanel();
        ...
        pnlPowerMode.AutoSize = false;
        pnlPowerMode.Controls.Add(radioOn);
        pnlPowerMode.Controls.Add(radioOff);
        pnlPowerMode.Dock = DockStyle.Top;
        pnlPowerMode.FlowDirection = FlowDirection.LeftToRight;
        pnlPowerMode.Location = new Point(0, 80);
        pnlPowerMode.Name = "pnlPowerMode";
        pnlPowerMode.Padding = new Padding(8, 7, 0, 0);
        pnlPowerMode.Size = new Size(384, 42);
        pnlPowerMode.TabIndex = 1;
        pnlPowerMode.WrapContents = false;

        radioOn.AutoSize = true;
        radioOn.Checked = true;
        radioOn.ForeColor = Color.DarkGreen;
        radioOn.Location = new Point(11, 10);
        ...
        radioOff.ForeColor = Color.OrangeRed;
        radioOff.Location = new Point(67, 10);
        ...
        ClientSize = new Size(384, 523);
        Controls.Add(tlpButtonsPanel);
        Controls.Add(pnlPowerMode);
        ...
        pnlPowerMode.ResumeLayout(false);
        pnlPowerMode.PerformLayout();
