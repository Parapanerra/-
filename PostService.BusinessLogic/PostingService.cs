...
public class PostingService : IPostingService
{
    ...
    {
        int maxId = _postings.Count == 0 ? 1 : _postings.Max(posting => posting.Id) + 1;
        newPosting.Id = maxId;
    ...
    public List<Posting> GetAll() => _postings;

    public Posting? Find(int postingId) => _postings.FirstOrDefault(posting => posting.Id == postingId);
